...
import com.tinslam.battleheart.states.WorldState;

public class Portal extends Entity3D {
    /**
     * Constructor.
     */
    public Portal(float x, float y, float z, float rotX, float rotY, float rotZ, float width, float height, float depth) {

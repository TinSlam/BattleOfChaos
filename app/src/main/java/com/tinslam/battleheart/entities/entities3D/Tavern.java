...
import com.tinslam.battleheart.states.TavernState;

public class Tavern extends Entity3D {
    /**
     * Constructor.
     */
    public Tavern(float x, float y, float z, float rotX, float rotY, float rotZ, float width, float height, float depth) {
    ...
    public void onActionUp() {
        ...
        GameView.setState(new TavernState(), "");
    }
